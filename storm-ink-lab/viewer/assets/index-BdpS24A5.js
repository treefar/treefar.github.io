...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Eo(e,t,n){let r=new Float32Array(fo),i=new q(0,1,0);return new Ii({name:`SphericalGaussianBlur`,defines:{n:fo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ko(),fragmentShader:`
	...
	`}var Ao=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new bi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`);function f(){return new Ii({type:`OutlineEffect`,uniforms:Ni.merge([Q.fog,Q.displacementmap,l]),vertexShader:u,fragmentShader:d,side:1})}function p(e){let t=o[e.uuid];return t===void 0&&(t={material:f(),used:!0,keepAlive:a,count:0},o[e.uuid]=t),t.used=!0,t.material}function m(e){let t=p(e);return s[t.uuid]=e,b(t,e),t}function h(e){let t=e.geometry,n=t!==void 0&&t.attributes.normal!==void 0;return e.isMesh===!0&&e.material!==void 0&&n===!0}function g(e){if(h(e)!==!1){if(Array.isArray(e.material))for(let t=0,n=e.material.length;t<n;t++)e.material[t]=m(e.material[t]);else e.material=m(e.material);c[e.uuid]=e.onBeforeRender,e.onBeforeRender=v}}function _(e){if(h(e)!==!1){if(Array.isArray(e.material))for(let t=0,n=e.material.length;t<n;t++)e.material[t]=s[e.material[t].uuid];else e.material=s[e.material.uuid];e.onBeforeRender=c[e.uuid]}}function v(e,t,n,r,i){let a=s[i.uuid];a!==void 0&&y(i,a)}function y(e,t){let n=t.userData.outlineParameters;e.uniforms.outlineAlpha.value=t.opacity,n!==void 0&&(n.thickness!==void 0&&(e.uniforms.outlineThickness.value=n.thickness),n.color!==void 0&&e.uniforms.outlineColor.value.fromArray(n.color),n.alpha!==void 0&&(e.uniforms.outlineAlpha.value=n.alpha)),t.displacementMap&&(e.uniforms.displacementMap.value=t.displacementMap,e.uniforms.displacementScale.value=t.displacementScale,e.uniforms.displacementBias.value=t.displacementBias)}function b(e,t){if(e.name===`invisible`)return;let n=t.userData.outlineParameters;e.fog=t.fog,e.toneMapped=t.toneMapped,e.premultipliedAlpha=t.premultipliedAlpha,e.displacementMap=t.displacementMap,n===void 0?(e.transparent=t.transparent,e.visible=t.visible):(e.visible=t.visible===!1?!1:n.visible===void 0||n.visible,e.transparent=n.alpha!==void 0&&n.alpha<1||t.transparent,n.keepAlive!==void 0&&(o[t.uuid].keepAlive=n.keepAlive)),(t.wireframe===!0||t.depthTest===!1)&&(e.visible=!1),t.clippingPlanes&&(e.clipping=!0,e.clippingPlanes=t.clippingPlanes,e.clipIntersection=t.clipIntersection,e.clipShadows=t.clipShadows),e.version=t.version}function x(){let e;e=Object.keys(s);for(let t=0,n=e.length;t<n;t++)s[e[t]]=void 0;e=Object.keys(c);for(let t=0,n=e.length;t<n;t++)c[e[t]]=void 0;e=Object.keys(o);for(let t=0,n=e.length;t<n;t++){let n=e[t];o[n].used===!1?(o[n].count++,o[n].keepAlive===!1&&o[n].count>60&&delete o[n]):(o[n].used=!1,o[n].count=0)}}this.render=function(t,n){if(this.enabled===!1){e.render(t,n);return}let r=e.autoClear;e.autoClear=this.autoClear,e.render(t,n),e.autoClear=r,this.renderOutline(t,n)},this.renderOutline=function(t,n){let r=e.autoClear,i=t.matrixWorldAutoUpdate,a=t.background,o=e.shadowMap.enabled;t.matrixWorldAutoUpdate=!1,t.background=null,e.autoClear=!1,e.shadowMap.enabled=!1,t.traverse(g),e.render(t,n),t.traverse(_),x(),t.matrixWorldAutoUpdate=i,t.background=a,e.autoClear=r,e.shadowMap.enabled=o},this.setSize=function(t,n){e.setSize(t,n)}}};function Rl(e,t=!1){let n=e[0].index!==null,r=new Set(Object.keys(e[0].attributes)),i=new Set(Object.keys(e[0].morphAttributes)),a={},o={},s=e[0].morphTargetsRelative,c=new Tr,l=0;for(let u=0;u<e.length;++u){let d=e[u],f=0;if(n!==(d.index!==null))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them.`),null;for(let e in d.attributes){if(!r.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure "`+e+`" attribute exists among all geometries, or in none of them.`),null;a[e]===void 0&&(a[e]=[]),a[e].push(d.attributes[e]),f++}if(f!==r.size)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. Make sure all geometries have the same number of attributes.`),null;if(s!==d.morphTargetsRelative)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. .morphTargetsRelative must be consistent throughout all geometries.`),null;for(let e in d.morphAttributes){if(!i.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`.  .morphAttributes must be consistent throughout all geometries.`),null;o[e]===void 0&&(o[e]=[]),o[e].push(d.morphAttributes[e])}if(t){let e;if(n)e=d.index.count;else if(d.attributes.position!==void 0)e=d.attributes.position.count;else return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. The geometry must have either an index or a position attribute`),null;c.addGroup(l,e,u),l+=e}}if(n){let t=0,n=[];for(let r=0;r<e.length;++r){let i=e[r].index;for(let e=0;e<i.count;++e)n.push(i.getX(e)+t);t+=e[r].attributes.position.count}c.setIndex(n)}for(let e in a){let t=zl(a[e]);if(!t)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` attribute.`),null;c.setAttribute(e,t)}for(let e in o){let t=o[e][0].length;if(t!==0){c.morphAttributes=c.morphAttributes||{},c.morphAttributes[e]=[];for(let n=0;n<t;++n){let t=[];for(let r=0;r<o[e].length;++r)t.push(o[e][r][n]);let r=zl(t);if(!r)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` morphAttribute.`),null;c.morphAttributes[e].push(r)}}}return c}function zl(e){let t,n,r,i=-1,a=0;for(let o=0;o<e.length;++o){let s=e[o];if(t===void 0&&(t=s.array.constructor),t!==s.array.constructor)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes.`),null;if(n===void 0&&(n=s.itemSize),n!==s.itemSize)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes.`),null;if(r===void 0&&(r=s.normalized),r!==s.normalized)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes.`),null;if(i===-1&&(i=s.gpuType),i!==s.gpuType)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes.`),null;a+=s.count*n}let o=new t(a),s=new ur(o,n,r),c=0;for(let t=0;t<e.length;++t){let r=e[t];if(r.isInterleavedBufferAttribute){let e=c/n;for(let t=0,i=r.count;t<i;t++)for(let i=0;i<n;i++){let n=r.getComponent(t,i);s.setComponent(t+e,i,n)}}else o.set(r.array,c);c+=r.count*n}return i!==void 0&&(s.gpuType=i),s}var Bl=wt.degToRad;function Vl(){let e=Jl(`sentinel_turret_01`);e.userData={assetId:`sentinel_turret_01`,units:`meters`,upAxis:`+Y`,forwardAxis:`+Z`};let t={body:Yl(`body_dark`,1514018),armor:Yl(`armor_light`,3425370),yellow:Yl(`accent_yellow`,13082698),cyan:new zi({name:`emissive_cyan`,color:5619409,emissive:1456706,emissiveIntensity:.65,gradientMap:Xl()})};Object.values(t).forEach(e=>{e.userData.outlineParameters={thickness:.006,color:[.035,.041,.055],alpha:1}});let n=Jl(`pivot_base`),r=Jl(`pivot_yaw`),i=Jl(`pivot_pitch`),a=Jl(`pivot_hatch`);e.add(n),n.add(r),r.add(i,a),Hl(n,t),Ul(r,t),Wl(i,t),Gl(a,t),$l(n,[r]),$l(r,[i,a]),$l(i,[]);let o=a.getObjectByName(`hatch_left`),s=a.getObjectByName(`hatch_right`);o&&$l(o,[]),s&&$l(s,[]);let c=new xn;c.name=`socket_muzzle`,c.position.set(0,.03,2.72),c.userData={purpose:`projectile-and-muzzle-flash`},i.add(c);let l=new xn;l.name=`socket_base`,l.position.set(0,0,0),l.userData={purpose:`placement-origin`},e.add(l);let u=Jl(`collider_base`);u.userData={collider:`cylinder`,sizeMeters:[2.2,.65,2.2]},e.add(u);let d=Jl(`collider_body`);d.position.y=1.26,d.userData={collider:`box`,sizeMeters:[1.8,1.05,2.1]},r.add(d);let f=Zl(e),p=Ql(e),m=Array.from(new Set([t.body,t.armor,t.yellow,t.cyan].map(e=>e.name))),h=new Map;e.traverse(e=>h.set(e.uuid,e.position.clone()));let g={root:e,basePivot:n,yawPivot:r,pitchPivot:i,hatchPivot:a,muzzleSocket:c,baseSocket:l,meshCount:f,triangleCount:p,materialNames:m,setPose(e){Kl(g,e)},setExploded(t){let n=wt.clamp(t,0,1);e.traverse(e=>{let t=h.get(e.uuid);if(!t||(e.position.copy(t),!(e instanceof Jr)))return;let r=e.getWorldPosition(new q);r.y=Math.max(.1,r.y),r.normalize().multiplyScalar(n*.48),e.position.add(r)})}};return g.setPose({pivot_base:0,pivot_yaw:-18,pivot_pitch:8,pivot_hatch:12}),g}function Hl(e,t){ql(e,`base_contact`,new Ei(1.08,1.18,.18,12),t.body,[0,.09,0]),ql(e,`base_armor_ring`,new Ei(.92,1.04,.28,12),t.armor,[0,.3,0]),ql(e,`base_bearing`,new Ei(.67,.75,.16,16),t.yellow,[0,.49,0]),ql(e,`base_core`,new Ei(.54,.62,.28,12),t.body,[0,.66,0]);for(let[n,r,i,a]of[[-.86,.09,-.72,-38],[.86,.09,-.72,38],[-.86,.09,.72,38],[.86,.09,.72,-38]]){let o=ql(e,`stabilizer_foot`,new wi(.68,.14,.54),t.body,[n,r,i]);o.rotation.y=Bl(a),ql(o,`foot_accent`,new wi(.38,.08,.58),t.armor,[0,.09,0])}}function Ul(e,t){e.position.y=.64,ql(e,`carriage_lower`,new wi(1.6,.42,1.62),t.body,[0,.28,0]),ql(e,`carriage_back`,new wi(1.42,.72,.84),t.armor,[0,.72,-.42]),ql(e,`carriage_front`,new wi(1.34,.66,.92),t.body,[0,.77,.44]),ql(e,`left_armor`,new wi(.22,.78,1.48),t.yellow,[-.76,.66,.04],[0,0,-8]),ql(e,`right_armor`,new wi(.22,.78,1.48),t.yellow,[.76,.66,.04],[0,0,8]);for(let n of[-1,1])ql(e,`cyan_status_strip`,new wi(.06,.16,.72),t.cyan,[n*.815,.66,.28]),ql(e,`side_bolt_upper`,new Ei(.08,.08,.06,10),t.armor,[n*.84,.92,-.2],[0,0,90]),ql(e,`side_bolt_lower`,new Ei(.08,.08,.06,10),t.armor,[n*.84,.48,-.2],[0,0,90])}function Wl(e,t){e.position.set(0,1.46,.18),ql(e,`rail_spine`,new wi(.44,.34,3.66),t.body,[0,0,.86]),ql(e,`rail_upper`,new wi(.24,.18,3.82),t.armor,[0,.22,.92]),ql(e,`rail_lower`,new wi(.28,.15,3.45),t.yellow,[0,-.22,.76]),ql(e,`barrel_inner`,new Ei(.11,.14,3.82,10),t.armor,[0,.02,.95],[90,0,0]),ql(e,`muzzle_block`,new wi(.62,.52,.54),t.body,[0,.02,2.42]),ql(e,`muzzle_ring`,new Ei(.27,.31,.32,12),t.yellow,[0,.02,2.72],[90,0,0]),ql(e,`muzzle_emitter`,new Ei(.15,.15,.08,16),t.cyan,[0,.02,2.9],[90,0,0]);for(let n of[-1,1])ql(e,`rail_brace`,new wi(.14,.54,1.85),t.armor,[n*.38,-.02,.52],[0,0,n*9]),ql(e,`rail_energy_strip`,new wi(.05,.08,2.35),t.cyan,[n*.27,.16,.92])}function Gl(e,t){e.position.set(0,1.6,-.42);for(let n of[-1,1]){let r=Jl(n<0?`hatch_left`:`hatch_right`);r.position.set(n*.38,0,-.1),e.add(r);let i=ql(r,`heat_vane`,new wi(.46,1.15,.16),t.yellow,[n*.14,.46,0]);i.rotation.z=Bl(n*-18),ql(r,`vane_insert`,new wi(.28,.78,.18),t.body,[n*.14,.45,.01],[0,0,n*-18])}}function Kl(e,t){if(t.pivot_base!==void 0&&(e.basePivot.rotation.z=Bl(t.pivot_base)),t.pivot_yaw!==void 0&&(e.yawPivot.rotation.y=Bl(t.pivot_yaw)),t.pivot_pitch!==void 0&&(e.pitchPivot.rotation.x=Bl(-t.pivot_pitch)),t.pivot_hatch!==void 0){let n=Bl(t.pivot_hatch),r=e.hatchPivot.getObjectByName(`hatch_left`),i=e.hatchPivot.getObjectByName(`hatch_right`);r&&(r.rotation.z=n),i&&(i.rotation.z=-n)}}function ql(e,t,n,r,i,a=[0,0,0]){let o=new Jr(n,r);return o.name=t,o.position.set(...i),o.rotation.set(...a.map(Bl)),o.castShadow=!0,o.receiveShadow=!0,e.add(o),o}function Jl(e){let t=new Sn;return t.name=e,t}function Yl(e,t){return new zi({name:e,color:t,gradientMap:Xl()})}function Xl(){let e=new Zr(new Uint8Array([52,55,63,255,132,133,128,255,236,224,199,255]),3,1,E);return e.minFilter=a,e.magFilter=a,e.generateMipmaps=!1,e.needsUpdate=!0,e}function Zl(e){let t=0;return e.traverse(e=>{e instanceof Jr&&(t+=1)}),t}function Ql(e){let t=0;return e.traverse(e=>{if(!(e instanceof Jr))return;let n=e.geometry;t+=n.index?n.index.count/3:(n.attributes.position?.count??0)/3}),Math.round(t)}function $l(e,t){e.updateWorldMatrix(!0,!0);let n=new Set(t),r=[],i=t=>{if(!(t!==e&&n.has(t))){t instanceof Jr&&r.push(t);for(let e of t.children)i(e)}};i(e);let a=new Map,o=e.matrixWorld.clone().invert();for(let e of r){if(Array.isArray(e.material))continue;e.updateWorldMatrix(!0,!1);let t=o.clone().multiply(e.matrixWorld),n=e.geometry.clone();n.applyMatrix4(t);let r=a.get(e.material)??[];r.push(n),a.set(e.material,r)}for(let e of r)e.removeFromParent();for(let[t,n]of a){let r=Rl(n,!1);for(let e of n)e.dispose();if(!r)throw Error(`Could not merge ${t.name} geometry in ${e.name}.`);let i=new Jr(r,t);i.name=`${e.name}_${t.name}_merged`,i.castShadow=!0,i.receiveShadow=!0,e.add(i)}}var eu={schemaVersion:`1.0.0`,id:`sentinel_turret_01`,displayName:`Sentinel Rail Turret`,category:`defense`,source:{kind:`project-authored-reference`,path:`/reference-turret-storm-ink.png`,view:`three-quarter front`,hiddenSurfacePolicy:`bilateral symmetry plus conservative rear housing`},dimensionsMeters:{width:2.4,height:2.55,depth:4.8},components:[{id:`base`,shape:`cylinders-and-boxes`,evidence:`visible armored plinth and four stabilizer feet`},{id:`yaw`,shape:`box-wedge-assembly`,evidence:`upper carriage rotates horizontally around central bearing`},{id:`pitch`,shape:`cylinders-and-boxes`,evidence:`rail barrel elevates independently from carriage`},{id:`hatch`,shape:`twin-panels`,evidence:`paired top fins read as deployable heat vanes`}],pivots:[{name:`pivot_base`,axis:`Y`,rangeDegrees:[-6,6]},{name:`pivot_yaw`,axis:`Y`,rangeDegrees:[-160,160]},{name:`pivot_pitch`,axis:`X`,rangeDegrees:[-12,48]},{name:`pivot_hatch`,axis:`Z`,rangeDegrees:[0,38]}],sockets:[{name:`socket_muzzle`,purpose:`projectile and muzzle flash origin`},{name:`socket_base`,purpose:`placement and attachment origin`}],colliders:[{name:`collider_base`,type:`cylinder`,sizeMeters:[2.2,.65,2.2]},{name:`collider_body`,type:`box`,sizeMeters:[1.8,1.05,2.1]}],materials:[`body_dark`,`armor_light`,`accent_yellow`,`emissive_cyan`],artDirection:{id:`storm-ink-chronicle`,rendering:`three-step toon shading with ink outline`,surface:`imagegen washi and dry-brush scuff map`},budgets:{trianglesMax:12e3,materialsMax:4,drawCallsMax:24}};function tu(e){let t=new Kn().setFromObject(e.root),n=t.getSize(new q),r=new Set;e.root.traverse(e=>r.add(e.name));let i=eu.pivots.map(e=>e.name).concat(eu.sockets.map(e=>e.name)),a=[{label:`Semantic pivots and sockets`,passed:i.every(e=>r.has(e)),measured:`${i.filter(e=>r.has(e)).length}/${i.length} named nodes`},{label:`Triangle budget`,passed:e.triangleCount<=eu.budgets.trianglesMax,measured:`${e.triangleCount.toLocaleString()} / ${eu.budgets.trianglesMax.toLocaleString()}`},{label:`Material budget`,passed:e.materialNames.length<=eu.budgets.materialsMax,measured:`${e.materialNames.length} / ${eu.budgets.materialsMax}`},{label:`Draw-call estimate`,passed:e.meshCount<=eu.budgets.drawCallsMax,measured:`${e.meshCount} / ${eu.budgets.drawCallsMax}`},{label:`Base contact plane`,passed:Math.abs(t.min.y)<=.011,measured:`Y ${t.min.y.toFixed(3)} m`},{label:`Overall dimensions`,passed:n.x<=eu.dimensionsMeters.width*1.35&&n.y<=eu.dimensionsMeters.height*1.35&&n.z<=eu.dimensionsMeters.depth*1.35,measured:`${n.x.toFixed(2)} × ${n.y.toFixed(2)} × ${n.z.toFixed(2)} m`}];return{passed:a.every(e=>e.passed),items:a}}var nu={id:`sentinel_turret_01`,version:`2.0.0`,generator:`native-threejs-semantic-factory`,created:`2026-08-12`,units:`meters`,upAxis:`+Y`,forwardAxis:`+Z`,origin:`center of base contact plane`,license:{code:`project-authored`,referenceArt:`project-authored`,thirdPartyAssets:[]},provenance:{referenceImage:`public/reference-turret-storm-ink.png`,surfaceTexture:`public/T_StormInk_WashiScuffs.png`,artDirection:`ArtDirection/References/REF_StormInkChronicle_Master.png`,imageGeneration:`OpenAI built-in imagegen, 2026-08-12`,referenceCommit:`local-worktree`,hiddenSurfaces:`inferred and marked by policy in model.spec.json`},export:{format:`glTF 2.0 binary`,preserveNodeNames:!0,includeCustomExtensions:!0}},ru=`modulepreload`,iu=function(e,t){return new URL(e,t).href},au={},ou=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=iu(t,n),t=s(t),t in au)return;au[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:ru,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},su=document.querySelector(`#app`);if(!su)throw Error(`Missing #app root.`);var cu=[{name:`pivot_base`,label:`Base lean`,minimum:-6,maximum:6,value:0},{name:`pivot_yaw`,label:`Turret yaw`,minimum:-160,maximum:160,value:-18},{name:`pivot_pitch`,label:`Rail pitch`,minimum:-12,maximum:48,value:8},{name:`pivot_hatch`,label:`Heat vanes`,minimum:0,maximum:38,value:12}];su.innerHTML=`
  <main class="app-shell">
    <header class="topbar">
      <div class="brand">
        <div class="brand-mark">◈</div>
        <div><h1>IMG2THREEJS / SENTINEL LAB</h1><p>semantic hard-surface reconstruction</p></div>
      </div>
      <div class="top-actions">
        <button class="action" id="reset-camera">Reset view</button>
        <button class="action" id="download-spec">Spec JSON</button>
        <button class="action primary" id="export-glb">Export GLB</button>
      </div>
    </header>
    <section class="workspace">
      <aside class="sidebar left">
        <div class="section reference-card">
          <img src="./reference-turret-storm-ink.png" alt="Storm Ink Chronicle turret reference" />
          <span class="reference-label">PROJECT-AUTHORED REFERENCE</span>
        </div>
        <div class="section">
          <h2>Articulation</h2>
        ...
        <div class="section">
          <h2>Preview modes</h2>
          ${Ru(`auto-rotate`,`Auto rotate`,!1)}
          ${Ru(`show-bounds`,`Bounds`,!0)}
          ${Ru(`show-axes`,`Axes`,!0)}
          <div class="pivot-control" style="margin-top:14px">
            <div class="pivot-row"><span>Exploded view</span><span class="pivot-value" id="explode-value">0%</span></div>
            <input id="explode" type="range" min="0" max="100" value="0" />
          </div>
        </div>
        <div class="section">
          <h2>Lighting</h2>
          <button class="action" data-light="studio">Studio</button>
          <button class="action" data-light="night">Night</button>
          <button class="action" data-light="clay">Clay</button>
        </div>
      </aside>
      <div class="viewport" id="viewport">
        <canvas id="viewport-canvas" tabindex="0" aria-label="Interactive 3D turret preview"></canvas>
        <div class="viewport-badge"><strong>${eu.displayName}</strong>Orbit • zoom • inspect</div>
        <div class="axis-legend"><span class="axis-x">X</span><span class="axis-y">Y</span><span class="axis-z">Z</span></div>
      </div>
      <aside class="sidebar right">
        <div class="section">
          ...
          <div class="metric-grid">
            ...
            <div class="metric"><span>Meshes</span><strong id="meshes">—</strong></div>
            <div class="metric"><span>Materials</span><strong id="materials">—</strong></div>
            <div class="metric"><span>Named nodes</span><strong id="nodes">—</strong></div>
          </div>
        </div>
        <div class="section">
        ...
        <div class="section">
          <h2>Contract</h2>
          <div class="validation-item"><span class="dot pass"></span><div><strong>${nu.units} / ${nu.upAxis} up</strong><span>${nu.forwardAxis} forward • ${nu.origin}</span></div></div>
        </div>
      </aside>
    </section>
    <footer class="statusbar"><span id="status" class="status-ok">READY / VALIDATED</span><span>Three.js r185 • no Unity bridge</span></footer>
  </main>
  <div id="toast" class="toast" role="status"></div>
`;var lu=Uu(`#viewport-canvas`),uu=Uu(`#viewport`),du=new ml({canvas:lu,antialias:!0,alpha:!0,powerPreference:`high-performance`});du.setPixelRatio(Math.min(window.devicePixelRatio,2)),du.shadowMap.enabled=!0,du.shadowMap.type=1,du.outputColorSpace=Ie,du.toneMapping=0;var fu=new Ll(du,{defaultThickness:.0055,defaultColor:[.035,.041,.055],defaultAlpha:1}),pu=new jn;pu.background=new X(2107957),pu.fog=new An(2107957,.026);var mu=new Sa(38,1,.1,100),hu=new q(5.8,3.9,7.2);mu.position.copy(hu);var gu=new wl(mu,lu);gu.enableDamping=!0,gu.dampingFactor=.06,gu.minDistance=4.2,gu.maxDistance=15,gu.maxPolarAngle=Math.PI*.49,gu.target.set(0,1.15,.3);var _u=Vl();pu.add(_u.root),Iu(_u.root);var vu=new qa(_u.root,7989503);pu.add(vu);var yu=new Ja(2.4);pu.add(yu);var bu=new Ga(18,36,2111303,1516590);bu.position.y=-.002,pu.add(bu);var xu=new Jr(new Ti(5.4,64),new zi({color:1514018}));xu.rotation.x=-Math.PI*.5,xu.receiveShadow=!0,xu.position.y=-.006,pu.add(xu);var Su=Nu(pu),Cu=!1,wu=0,Tu=new Aa;Tu.connect(document),Pu(`studio`,!1),Du(_u),Au(_u),Mu(_u),ju(_u),Ou(_u);function Eu(e){wu=requestAnimationFrame(Eu),Tu.update(e);let t=Tu.getDelta();Cu&&(_u.yawPivot.rotation.y+=t*.28),gu.update(),vu.update(),Fu(),fu.render(pu,mu)}Eu(),window.addEventListener(`beforeunload`,()=>{cancelAnimationFrame(wu),Tu.dispose()});function Du(e){let t=Uu(`#pivot-controls`);t.innerHTML=cu.map(e=>`
    <div class="pivot-control">
      <div class="pivot-row"><span>${e.label}</span><span class="pivot-value" id="value-${e.name}">${e.value}°</span></div>
      <input data-pivot="${e.name}" type="range" min="${e.minimum}" max="${e.maximum}" value="${e.value}" />
    </div>
  `).join(``),t.querySelectorAll(`input[data-pivot]`).forEach(t=>{t.addEventListener(`input`,()=>{let n=t.dataset.pivot,r=Number(t.value);e.setPose({[n]:r}),Uu(`#value-${n}`).textContent=`${r}°`})})}function Ou(e){Uu(`#reset-camera`).addEventListener(`click`,()=>{mu.position.copy(hu),gu.target.set(0,1.15,.3),gu.update(),Bu(`Camera restored`)}),Uu(`#download-spec`).addEventListener(`click`,()=>zu(`sentinel_turret_01.spec.json`,new Blob([JSON.stringify(eu,null,2)],{type:`application/json`}))),Uu(`#export-glb`).addEventListener(`click`,()=>void ku(e)),Lu(`auto-rotate`,e=>{Cu=e}),Lu(`show-bounds`,e=>{vu.visible=e}),Lu(`show-axes`,e=>{yu.visible=e});let t=Uu(`#explode`);t.addEventListener(`input`,()=>{let n=Number(t.value);e.setExploded(n/100),Uu(`#explode-value`).textContent=`${n}%`}),document.querySelectorAll(`button[data-light]`).forEach(e=>e.addEventListener(`click`,()=>Pu(e.dataset.light??`studio`,!0)))}async function ku(e){Vu(`EXPORTING GLB…`,!1);try{let{GLTFExporter:t}=await ou(async()=>{let{GLTFExporter:e}=await import(`./GLTFExporter-B9VJIMmB.js`);return{GLTFExporter:e}},[],import.meta.url),n=new t,r=e.root.clone(!0);r.traverse(e=>{if(!(e instanceof Jr)||Array.isArray(e.material))return;let t=e.material;t instanceof zi&&(e.material=new Ri({name:t.name,color:t.color,emissive:t.emissive,emissiveIntensity:t.emissiveIntensity,map:t.map,roughness:.92,metalness:.02}))});let i=await n.parseAsync(r,{binary:!0,onlyVisible:!0,trs:!0,includeCustomExtensions:!0});if(!(i instanceof ArrayBuffer)||i.byteLength<1e3)throw Error(`GLB exporter returned an empty result.`);zu(`sentinel_turret_01.glb`,new Blob([i],{type:`model/gltf-binary`})),Vu(`GLB READY / ${Hu(i.byteLength)}`,!0),Bu(`GLB exported • ${Hu(i.byteLength)}`)}catch(e){Vu(`GLB EXPORT FAILED`,!1),Bu(e instanceof Error?e.message:`GLB export failed`)}}function Au(e){let t=0;e.root.traverse(()=>t+=1),Uu(`#triangles`).textContent=e.triangleCount.toLocaleString(),Uu(`#meshes`).textContent=String(e.meshCount),Uu(`#materials`).textContent=String(e.materialNames.length),Uu(`#nodes`).textContent=String(t)}function ju(e){let t=tu(e);Uu(`#validation-list`).innerHTML=t.items.map(e=>`
    <div class="validation-item"><span class="dot ${e.passed?`pass`:``}"></span><div><strong>${e.label}</strong><span>${e.measured}</span></div></div>
  `).join(``),Vu(t.passed?`READY / VALIDATED`:`VALIDATION FAILED`,t.passed),document.documentElement.dataset.validated=String(t.passed)}function Mu(e){let t=[e.root,e.basePivot,e.yawPivot,e.pitchPivot,e.hatchPivot,e.muzzleSocket,e.baseSocket],n=Uu(`#node-tree`);n.innerHTML=t.map((e,t)=>`<button data-node="${e.name}">${t===0?``:`└─ `}${e.name}</button>`).join(``),n.querySelectorAll(`button[data-node]`).forEach(t=>t.addEventListener(`click`,()=>{n.querySelectorAll(`button`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`);let r=(e.root.getObjectByName(t.dataset.node??e.root.name)??e.root).getWorldPosition(new q);gu.target.lerp(r,.85),Bu(t.dataset.node??`node`)}))}function Nu(e){let t=new ua(15327431,1514018,1.45),n=new Ta(15327431,3.4);n.position.set(4.8,7.2,5.5),n.castShadow=!0,n.shadow.mapSize.set(2048,2048),n.shadow.camera.near=.5,n.shadow.camera.far=28;let r=new Ta(5619409,2.15);return r.position.set(-4.5,3.4,-5.2),e.add(t,n,r),{ambient:t,key:n,rim:r}}function Pu(e,t){e===`night`?(Su.ambient.intensity=.48,Su.key.intensity=1.1,Su.rim.intensity=3.6):e===`clay`?(Su.ambient.intensity=2.4,Su.key.intensity=2.7,Su.rim.intensity=.45):(Su.ambient.intensity=1.45,Su.key.intensity=3.4,Su.rim.intensity=2.15),t&&Bu(`Lighting • ${e}`)}function Fu(){let e=uu.clientWidth,t=uu.clientHeight,n=du.getPixelRatio();(lu.width!==Math.floor(e*n)||lu.height!==Math.floor(t*n))&&(du.setSize(e,t,!1),fu.setSize(e,t),mu.aspect=e/Math.max(t,1),mu.updateProjectionMatrix())}function Iu(e){let t=new ca().load(`./T_StormInk_WashiScuffs.png`);t.colorSpace=Ie,t.wrapS=n,t.wrapT=n,t.repeat.set(1.7,1.7),e.traverse(e=>{!(e instanceof Jr)||Array.isArray(e.material)||e.material instanceof zi&&(e.material.map=t,e.material.needsUpdate=!0)})}function Lu(e,t){let n=Uu(`#${e}`);n.addEventListener(`click`,()=>{let e=n.dataset.on!==`true`;n.dataset.on=String(e),t(e)}),t(n.dataset.on===`true`)}function Ru(e,t,n){return`<div class="toggle-row"><span>${t}</span><button class="switch" id="${e}" data-on="${String(n)}" aria-label="Toggle ${t}"></button></div>`}function zu(e,t){let n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=e,r.click(),setTimeout(()=>URL.revokeObjectURL(n),1e3)}function Bu(e){let t=Uu(`#toast`);t.textContent=e,t.classList.add(`visible`),window.setTimeout(()=>t.classList.remove(`visible`),1500)}function Vu(e,t){let n=Uu(`#status`);n.textContent=e,n.classList.toggle(`status-ok`,t)}function Hu(e){return e<1024?`${e} B`:`${(e/1024).toFixed(1)} KB`}function Uu(e){let t=document.querySelector(e);if(!t)throw Error(`Missing required element: ${e}`);return t}export{Lt as C,jn as S,Ua as _,Ft as a,n as b,c,wt as d,qt as f,o as g,s as h,yi as i,u as l,a as m,r as n,Me as o,i as p,X as r,R as s,ur as t,l as u,Tt as v,q as w,Ie as x,E as y};